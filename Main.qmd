...
5.   Users cannot customize the time range or select specific years of interest, limiting the depth of their analysis.

6.  While some elements are interactive, the visualization could benefit from more dynamic features such as changing bubble sizes or color gradients to depict demographic shifts over time.
