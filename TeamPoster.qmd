...
ui <- fluidPage(
  ...
  sliderInput("year_slider", "Select Year:", 
    ...
    # Create a dropdown menu for Agegroup
  selectInput("agegroup_filter", "Select Age Group:",
  ...
  output$map <- renderLeaflet({
    ...
    leaflet(reactive_data()) %>% 
      addPolygons(
        ...
        label = ~paste0("Planning Area: ", Name, "Total Population (", input$year_slider, "): ", TotalPop),
